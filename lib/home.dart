...
import 'package:markdownapp/settings.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          //                                 } else {
          //                                   con.saveFile(
          //                                       content: con.mdText.text,
          //                                       filename: con.fileName.text);
          //                                   Get.back(closeOverlays: true);
          //                                   con.tabcon.index = 0;
          //                                   con.mdText.text = "";
          //                                   con.fileName.text = "";
      ...
      bottomNavigationBar: BottomAppBar(
        ...
        child: Row(
          children: [
            IconButton(tooltip:'open external file',onPressed: () {
              con.openExternalFile();
              Get.back(closeOverlays: true);
            },
